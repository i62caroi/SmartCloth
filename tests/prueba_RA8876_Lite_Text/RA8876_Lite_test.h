...
#ifndef _RA8876_LITE_TEST_H
#define _RA8876_LITE_TEST_H
...
#define RA8876_GT30L16U2W   1 //ESTAAAAA
...
bool calcPllParams(uint32_t targetFreq, int kMax, PllParams *pll);      // Incluido en ra8876PllInitial() en RA8876_Lite
 ...
 void lcdRegDataWrite16(ru8 reg, ru16 data);
