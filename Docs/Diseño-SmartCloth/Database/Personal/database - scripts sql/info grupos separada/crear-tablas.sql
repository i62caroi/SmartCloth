/*
    ...
    - GRUPO_ALIMENTO(grupo, id_tipo, id_base)
    ...
    - `GrupoAlimento`: Almacena información (id y enlace a info base) sobre los diferentes grupos de alimentos, que están asociados a un tipo de alimento.
...
CREATE TABLE GrupoAlimento (
    grupo INT PRIMARY KEY, -- id del grupo
    id_base INT NOT NULL, -- información de 'nombre' y 'ejemplos'
    id_tipo INT NOT NULL, -- tipo de alimento al que hace referencia
    CONSTRAINT fk_Grupo_Base FOREIGN KEY (id_base) REFERENCES GrupoAlimentoBase(id_base),
