...
void setup()
{
  ...
  /*tft.clearScreen(0);
  tft.sdCardDrawBMP("BMP_2.bmp", 0, 0);
  delay(2000);
  */
  tft.clearScreen(0);
  //tft.sdCardDrawBMP("smart24.bmp", 0, 0);
  ...
  tft.clearScreen(0);
  tft.sdCardShowPicture16bpp(500,100,189,181,"crudo.bin");
  delay(2000);

  tft.clearScreen(0);
  tft.sdCardShowPicture16bpp(300,300,189,181,"cocinado.bin");
  delay(2000);

  tft.clearScreen(0);
  tft.sdCardShowPicture16bpp(50,50,768,558,"image.bin");
  delay(2000);
*/
