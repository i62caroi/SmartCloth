...
html_ov2640 = gzip.decompress(index_ov2640)
html_ov3660 = gzip.decompress(index_ov3660)
html_ov5640 = gzip.decompress(index_ov5640)

# Imprimir el contenido HTML
#print(html.decode())

# Escribir el contenido HTML en un archivo
with open('index_ov2640.html', 'w') as f:
    f.write(html_ov2640.decode())
    
with open('index_ov3660.html', 'w') as f:
    f.write(html_ov3660.decode())
    
with open('index_ov5640.html', 'w') as f:
    f.write(html_ov5640.decode())
    
print("\nEstructuras gzip descomprimidas y guardadas\n")