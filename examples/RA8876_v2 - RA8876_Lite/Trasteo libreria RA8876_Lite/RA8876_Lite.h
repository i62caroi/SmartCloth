...
class Ra8876_Lite
{
 ...
 int _xnscs, _xnreset;
 public:
 Ra8876_Lite(int xnscs, int xnreset); 		// HECHO EN RA8876_V2	
 boolean begin(void);						// HECHO EN RA8876_V2
  
 boolean ra8876Initialize(void); 			// HECHO EN RA8876_V2
 boolean ra8876PllInitial (void);			// HECHO EN RA8876_V2
 boolean ra8876SdramInitial(void);			// HECHO EN RA8876_V2

 /*access*/
 void lcdRegWrite(ru8 reg);					// HECHO EN RA8876_V2
 void lcdDataWrite(ru8 data);				// HECHO EN RA8876_V2
 ru8 lcdDataRead(void);						// HECHO EN RA8876_V2
 ru8 lcdStatusRead(void);					// HECHO EN RA8876_V2
 void lcdRegDataWrite(ru8 reg,ru8 data);	// HECHO EN RA8876_V2
 ru8 lcdRegDataRead(ru8 reg);				// HECHO EN RA8876_V2
 void lcdDataWrite16bbp(ru16 data); 		// NEW EN RA8876_V2
 /*Staus*/
 void checkWriteFifoNotFull(void);			// ~ HECHO EN RA8876_V2
 void checkWriteFifoEmpty(void);			// NEW EN RA8876_V2
 void checkReadFifoNotFull(void);
 void checkReadFifoFull(void);
 void checkReadFifoNotEmpty(void);
 void check2dBusy(void);					// ~ HECHO EN RA8876_V2
 boolean checkSdramReady(void);
 ru8 powerSavingStatus(void);
 boolean checkIcReady(void);				
 
 void displayOn(boolean on);					// No se hace en RA8876_v2 porque es costoso (lineas 754-769)
 void lcdHorizontalWidthVerticalHeight(ru16 width,ru16 height);		// HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void lcdHorizontalNonDisplay(ru16 numbers);	// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void lcdHsyncStartPosition(ru16 numbers);		// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void lcdHsyncPulseWidth(ru16 numbers);			// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void lcdVerticalNonDisplay(ru16 numbers);		// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void lcdVsyncStartPosition(ru16 numbers);		// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void lcdVsyncPulseWidth(ru16 numbers);			// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void displayImageStartAddress(ru32 addr);		// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void displayImageWidth(ru16 width);			// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void displayWindowStartXY(ru16 x0,ru16 y0);	// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void canvasImageStartAddress(ru32 addr);		// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void canvasImageWidth(ru16 width);				// PANÁ => HECHO (en initDisplay(), no funcion) EN RA8876_V2
 void activeWindowXY(ru16 x0,ru16 y0);			// ¡¡ÚTIL!! => NEW EN RA8876_V2
 void activeWindowWH(ru16 width,ru16 height);	// ¡¡ÚTIL!! => NEW EN RA8876_V2
 ...
 void setPixelCursor(ru16 x,ru16 y);				// NEW EN RA8876_V2
 void putPixel_16bpp(ru16 x,ru16 y,ru16 color);		// HECHO EN RA8876_V2
 ...
 void putPicture_16bpp(ru16 x,ru16 y,ru16 width, ru16 height, const unsigned short *data); 		// NEW EN RA8876_V2
 
 /*text function*/
 void textMode(boolean on);											// HECHO EN RA8876_V2
 void textColor(ru16 foreground_color,ru16 background_color);		// PARECIDO EN RA8876_V2
 void setTextCursor(ru16 x,ru16 y);									// HECHO EN RA8876_V2
 ...
 /*draw function*/
 void drawLine(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color);									// HECHO EN RA8876_V2
 void drawSquare(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color);								// HECHO EN RA8876_V2
 void drawSquareFill(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color);							// HECHO EN RA8876_V2
 ...
 void drawTriangle(ru16 x0,ru16 y0,ru16 x1,ru16 y1,ru16 x2,ru16 y2,ru16 color);					// HECHO EN RA8876_V2
 void drawTriangleFill(ru16 x0,ru16 y0,ru16 x1,ru16 y1,ru16 x2,ru16 y2,ru16 color);				// HECHO EN RA8876_V2
 void drawCircle(ru16 x0,ru16 y0,ru16 r,ru16 color);											// HECHO EN RA8876_V2
 void drawCircleFill(ru16 x0,ru16 y0,ru16 r,ru16 color);										// HECHO EN RA8876_V2
 ...
 void bteMpuWriteWithROP(ru32 s1_addr,ru16 s1_image_width,ru16 s1_x,ru16 s1_y,ru32 des_addr,ru16 des_image_width,		// HECHO EN RA8876_V2
