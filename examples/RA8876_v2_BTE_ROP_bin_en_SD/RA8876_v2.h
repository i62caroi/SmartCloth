...
#define RA8876_SPI_SPEED 30000000 //30MHz
...
public:
  ...
  void setTextColor(uint16_t color) { m_textColor = color; };       // Parecido a textColor() en RA8876_Lite
  ...
  void bteMpuWriteWithROP(uint32_t s1_addr,uint16_t s1_image_width,uint16_t s1_x,uint16_t s1_y,     
                          uint32_t des_addr,uint16_t des_image_width,uint16_t des_x,uint16_t des_y,
                          uint16_t width,uint16_t height,uint8_t rop_code); 
  ...
  // ------ SD -------------
  void sdCardDrawBMP(char *filename, int x, int y);
  void sdCardShowPicture16bpp(uint16_t x,uint16_t y,uint16_t width, uint16_t height,char *filename);
  void sdCardShowPicture16bppBteMpuWriteWithROP(uint32_t s1_addr, uint16_t s1_image_width, uint16_t s1_x, uint16_t s1_y,
                                             uint32_t des_addr, uint16_t des_image_width, uint16_t des_x, uint16_t des_y, 
                                              uint16_t width, uint16_t height,uint8_t rop_code,char *filename);
  /* ------------------------------------------------------------ */
